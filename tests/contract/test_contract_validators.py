...
class ContractValidatorsTest(unittest.TestCase):
    ...
    def test_openapi_refs_paths_and_operations_are_resolvable(self) -> None:
        ...
        self.assertEqual(55, result.paths)
        self.assertEqual(60, result.operations)
