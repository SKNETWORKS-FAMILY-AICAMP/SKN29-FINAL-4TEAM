...
fun CustomerNavigation(runtimeSubscriptionId: String) {
    ...
    NavHost(
        ...
        composable(
            ...
            SymptomIntakeScreen(
                subscriptionId =
                    entry.arguments?.getString("subscriptionId").orEmpty(),
        ...
        composable(
            ...
            val scenario = runCatching {
                MockScenario.valueOf(
                    entry.arguments?.getString("scenario").orEmpty(),
                )
            }.getOrDefault(MockScenario.NO_EVIDENCE)

            InquiryCreatedScreen(
                inquiryId =
                    entry.arguments?.getString("inquiryId").orEmpty(),
