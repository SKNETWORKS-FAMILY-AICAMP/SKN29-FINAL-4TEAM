...
import com.skn29.watercare.ui.customer.CustomerServiceCallScreen
...
fun WaterCareApp() {
    ...
    NavHost(
        ...
        composable(Routes.SERVICE_CALL) {
            CustomerServiceCallScreen(
                onBack = navController::popBackStack
            )
        }

        // 기존 화면은 이전 시나리오 호환을 위해 유지한다.
