...
- [프로젝트 기획서 v0.1](weekly_output/기획서_v0.1.docx) — 프로젝트 범위와 대표 시나리오, 문제 정의, 시장·BM 분석, 시스템 구성과 검증 방향을 정리했습니다.
- [수집 데이터 보고서 v1](weekly_output/수집_데이터_보고서_v1.docx) — MVP·후속 확장 대상의 공식 매뉴얼·FAQ 수집, 자동화 절차, 저장 포맷, 법적·윤리적 검토와 품질 관리 방안을 정리했습니다.
- [화면설계서 초안 v0.2](weekly_output/화면설계서_초안_v0.2.docx) — 고객·상담사·방문기사·운영 담당자의 화면 목록과 업무 인계 흐름, 상태·권한 정책, 주요 와이어프레임을 정리했습니다.
...
| --- | --- | --- | --- |
| 윤&#8288;승&#8288;혁 | PM 통합 기획 및 최종 검수 | PM | 요구사항 정합성 확인, 역할별 산출물 통합 검토, 시연·최종 산출물 검수 |
| 최&#8288;지&#8288;용 | 비즈니스 서비스 기획 | 기획 | 고객 케어·상담·A/S 서비스 흐름, 사용자 역할과 상태 전이 기획 |
| 양&#8288;정&#8288;현 | 시스템·AI 구조 설계 | AI | 다중 Agent, RAG, 안전 규칙과 시스템 연계 구조 설계 |
| 김&#8288;은&#8288;진 | 데이터 수집 및 수집 절차 설계 | AI · 데이터 | 대상 모델의 공식 매뉴얼·FAQ 수집, 출처·버전·페이지 메타데이터와 RAG 입력 자료 정리 |
| 이&#8288;동&#8288;윤 | 데이터 구조·저장 방식 설계 및 품질 검토 | 백엔드 · 데이터 | ERD·표준 코드·저장 구조 설계, 데이터 품질과 추적성 검토 |
| 한&#8288;예&#8288;나 | UX 화면 흐름·와이어프레임 설계 | 프론트엔드 · UX | 고객·상담사·방문기사 화면 흐름과 공통 UI 구조 설계 |
