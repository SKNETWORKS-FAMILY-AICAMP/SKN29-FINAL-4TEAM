...
| 지침서 | Web 완료 내용 | 판정 |
| --- | --- | --- |
| 3.1 실행 환경·Router·권한·오류 | Vite·TypeScript 실행, AuthGuard·RoleGuard, 상담사·운영자·403·404 경로, env와 README | 완료 |
| 3.2 공통 API·상태·근거 UI | ApiResponse·ApiError·PageInfo·httpClient·RequestContext, 공통 Badge·DataTable·Pagination·Feedback·EvidenceCard | 완료 |
