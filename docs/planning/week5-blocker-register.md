...
| `W5-BLK-004` | 3.4 | Contract CI Workflow·자체 Test Local PASS, Commit·원격 Run 없음 | 김은진·윤승혁 | Branch/PR에서 필수 7개 Gate PASS와 Run URL 확인 | 8/12 | `LOCAL_APPLIED_REMOTE_NOT_RUN` |
