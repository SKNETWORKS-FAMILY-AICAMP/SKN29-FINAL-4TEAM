...
| 환경 구성·Seed·Smoke 재현 순서 | [Django·PostgreSQL 공유 패키지 인계서](../../manuals/20260727_최지용_Django_PostgreSQL_공유패키지_인계서_v1.0.md) |
...
[Django·PostgreSQL 공유 패키지 인계서](../../manuals/20260727_최지용_Django_PostgreSQL_공유패키지_인계서_v1.0.md)를
따른다.
