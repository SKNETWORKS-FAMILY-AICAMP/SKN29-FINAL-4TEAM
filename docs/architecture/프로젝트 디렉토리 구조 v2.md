...
└─ individual/jiyong/
   ...
   ├─ manuals/
   │  ├─ 20260728_최지용_Django_PostgreSQL_공유패키지_인계서_v1.1.md  # 역사 기록
   │  ├─ 20260729_최지용_Django_PostgreSQL_공유패키지_인계서_v1.2.md  # 역사 기록
   │  ├─ 20260729_최지용_Django_PostgreSQL_공유패키지_인계서_v1.3.md  # 현재 실행 기준
