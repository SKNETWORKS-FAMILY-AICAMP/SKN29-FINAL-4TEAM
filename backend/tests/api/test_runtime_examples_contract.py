...
EXPECTED_JSON_FILES = {
    ...
    "consultations/claim-consultation-success.json",
    ...
    "questionnaires/save-request.json",
    "questionnaires/save-response.json",
    "questionnaires/start-request.json",
    "questionnaires/start-response.json",
    "questionnaires/submit-request.json",
    "questionnaires/submit-response.json",
